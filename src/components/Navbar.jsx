...
export default function Navbar() {
  ...
  const farmerLinks = [{to:'/feed',l:'My Feed'},{to:'/crops',l:'Wiki'},{to:'/practices',l:'Practices'},{to:'/fields',l:'My Farm'},{to:'/learn',l:'Learn'},{to:'/experts',l:'Experts'},{to:'/simulator',l:'Simulator'},{to:'/predictor',l:'Predict'},{to:'/pest-health',l:'Scan'},{to:'/market',l:'Market'},{to:'/community',l:'Community'}]
